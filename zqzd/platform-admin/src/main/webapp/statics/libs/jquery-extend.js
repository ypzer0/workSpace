(function ($) {
    ...
    jQuery.extend(Array.prototype, {
        ...
        groupBy: function(key){
            ...
            for(var pk = 0; pk < this.length; pk ++){
                var findRt = '';
                for(var rtk = 0; rtk < rt.val.length; rtk ++){
        			if(rt.val[rtk].key === this[pk][key]){
        				findRt = rt.val[rtk].val;
        				break;
                    }
                }
        		if(findRt != ''){
        			...
        			rt.val.push({key:this[pk][key], val: [this[pk]] })
                }
            }
        	return rt;
        }
