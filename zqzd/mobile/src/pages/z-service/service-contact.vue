    ...
    <div class="urse-category-order1">
      ...
      <div class="urse-category-order-iner add">
        <div class="urse-category-order-iner-left">
          ...
          <p class="urse-category-order-iner-name">客服微信：{{ConfigContactDto.wechart}}</p>
        </div>
      </div>
      ...
      <div class="urse-category-order-iner">
        <div class="urse-category-order-iner-left">
          ...
          <p class="urse-category-order-iner-name">联系电话：{{ConfigContactDto.phone}}</p>
        </div>
      </div>
    </div>
...
export default {
  computed: {
    ...mapState('zd_service',['ConfigContactDto'])
  },
  components: {
    
  },
  methods: {
    ...mapActions('zd_service',['serviceInfo'])
  },
  created() {
    this.serviceInfo()
  },
