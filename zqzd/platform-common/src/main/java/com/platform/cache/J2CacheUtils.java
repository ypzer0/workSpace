...
public class J2CacheUtils {
     ...
     * 商城业务缓存
     */
    public static String SHOP_CACHE_NAME = "couponShopCache";
    /**
     * 系统缓存
     */
    private static String SYS_CACHE_NAME = "couponSysCache";
    
    
    private static String WEIXIN_CACHE_NAME = "couponWeiXinCache";
    ...
    /**
     * 获取WEIXIN_CACHE_NAME缓存
     *
     * @param key
     * @return
     */
    public static Object getWeiXin(String key) {
        return get(WEIXIN_CACHE_NAME, key);
    }
     ...
     * @return
     */
    public static void putWeiXin(String key, Object value) {
        put(WEIXIN_CACHE_NAME, key, value);
    }
     ...
     * @param value
     */
    public static void put(String cacheName, String key, Object value, long time) {
        cache.set(cacheName, key, value, time, true);
    }
