...
public class DateUtils {
     ...
     * @return
     */
    public static Long getTimeDiffSeconds(Date dt1, Date dt2) {
        long second =dt2.getTime()-dt1.getTime();
        return second;
    }
     ...
     * @return
     */
    public static Long getTimeDiffSeconds(Date dt1) {
        long second = new Date().getTime() - dt1.getTime();
        return second;
    }
