...
//    static final String accessKeySecret = "yourAccessKeySecret";   // TODO 修改成自己的
    ...
    public static SendSmsResponse sendSms(
    		String pro, String domain, String keyId, String keySecret,String sign, String tempCode,
    		String telephone, Map<String, Object> code) throws ClientException {
        //可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
        //初始化acsClient,暂不支持region化
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", keyId, keySecret);
        DefaultProfile.addEndpoint("cn-hangzhou", "cn-hangzhou", pro, domain);
        ...
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode(tempCode);    // TODO 修改成自己的
