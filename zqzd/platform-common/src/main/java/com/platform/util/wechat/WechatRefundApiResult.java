...
public class WechatRefundApiResult {
	...
	public String toString() {
		return "\r\n {return_code:'" + return_code + "', return_msg:'" + return_msg + "', result_code:'" + result_code
				+ "', err_code:'" + err_code + "', err_code_des:'" + err_code_des + "', appid:'" + appid + "', mch_id:'"
				...
				+ "', refund_fee:'" + refund_fee + "', settlement_refund_fee:'" + settlement_refund_fee
				+ "', total_fee:'" + total_fee + "', settlement_total_fee:'" + settlement_total_fee + "', fee_type:'"
				+ fee_type + "', cash_fee:'" + cash_fee + "', cash_refund_fee:'" + cash_refund_fee
