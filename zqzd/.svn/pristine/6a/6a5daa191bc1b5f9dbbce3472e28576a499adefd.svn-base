...
public class SmsLogVo implements Serializable {
	...
	public String toString() {
		return "SmsLogVo [id=" + id + ", user_id=" + user_id + ", phone=" + phone + ", log_date=" + log_date
				+ ", sms_code=" + sms_code + ", send_status=" + send_status + ", sms_text=" + sms_text + ", type="
				+ type + ", is_used=" + is_used + "]";
	}
